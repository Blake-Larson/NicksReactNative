      ...
      <View>
        ...
        <VideoComponent fileName={`file://${RNFS.DocumentDirectoryPath}/${workoutVideo}.mp4`} awsLink={VideoData[currentNumber]['filename']} pausedVideo={paused}/>
          <View style={{flexDirection: 'row', paddingTop: 40, paddingLeft: 20}}>
            ...
            <View style={{width: ScreenWidth*.3, marginTop: 50, paddingLeft: 0}}>
            ...
            <View style={{width: ScreenWidth*.3, alignItems: 'center', paddingRight: 10, paddingTop: 15, paddingLeft: 35, justifyContent: 'center'}}>
        ...
        <View style={{alignItems: 'center', justifyContent: 'center',flexDirection: 'row', paddingTop: 5}}>
        {
          ...
          <View style={{alignItems: 'center', justifyContent: 'center',flexDirection: 'row', paddingTop: 10, paddingLeft: 25}}>
            <View style={{width: ScreenWidth*.3}}>
              <Text style={{color: "white", fontFamily: "System", fontSize: 22, marginTop: 12, marginLeft: 5}}>Up Next: </Text>
            </View>
            <View style={{width: ScreenWidth*.7}}>
              <Text style={{color: "white", fontFamily: "System", fontSize: 25, marginTop: 12, marginLeft: 25}}>{upNext}</Text>
            </View>
          </View>
        }
        {
          currentNumber == VideoData.length - 1 &&
          <View style={{alignItems: 'center', justifyContent: 'center',flexDirection: 'row', paddingLeft: 25}}>
            <View style={{width: ScreenWidth*.2}}></View>
